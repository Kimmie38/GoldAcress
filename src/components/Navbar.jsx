    ...
    <nav className="bg-gray-800 text-white fixed top-0 left-0 w-full z-50 shadow-md">
      <div className="max-w-6xl mx-auto px-6 md:px-12 py-2 flex justify-between items-center">
        ...
        <ul className="hidden md:flex space-x-6">
          <li><Link href="/" className="hover:text-yellow-400 text-1xl">Home</Link></li>
          <li><Link href="/about" className="hover:text-yellow-400 text-1xl">About Us</Link></li>
          <li><Link href="/contact" className="hover:text-yellow-400 text-1xl">Contact Us</Link></li>
          <li><Link href="/gallery" className="hover:text-yellow-400 text-1xl">Gallery</Link></li>
        </ul>
